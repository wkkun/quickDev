package com.ya.baseutil.util;

import androidx.collection.SimpleArrayMap;

import com.ya.baseutil.constant.RegexConstants;
...
public final class RegexUtils {
    ...
    public static boolean isFromAnyOfEmailProviders(String email, String[] emailProviders) {
        return com.ya.baseutil.util.ArrayUtils.contains(emailProviders, extractEmailProvider(email));
    }
